...
public class SendEmail {
    ...
    public static boolean run(String addressedTo, String subject, String content) {
        ...
        String fromAddress = "ameliehellners@gmail.com";//Your Email Address//
        String recipients = addressedTo.trim();
        String contentType = "text/plain";

        String smtpHost = "smtp.gmail.com";//Your Outgoing Mailbox//
        int smtpPort = 587;
        String username = "ameliehellners@gmail.com";//Your Mailbox Username//
        String password = "PramPram82";//Your Mailbox Password//
